...
(custom-set-variables
 ...
 '(package-selected-packages
   '(modus-themes go-mode xah-fly-keys which-key use-package switch-window swiper sudo-edit smex s rainbow-mode rainbow-delimiters popup-kill-ring page-break-lines org-bullets mark-multiple linum-relative ido-vertical-mode goose-theme fill-column-indicator expand-region diminish dash beacon avy)))
(custom-set-faces
